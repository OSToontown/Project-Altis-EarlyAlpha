...
#End Region
        ...
        Sub New()
            ...
            Size = New Size(166, 40)
            _TextAlignment = StringAlignment.Center
            P1 = New Pen(Color.FromArgb(0, 152, 224)) ' P1 = Border color
        End Sub
        ...
        Protected Overrides Sub OnResize(ByVal e As System.EventArgs)
            If Width > 0 AndAlso Height > 0 Then
                ...
                PressedGB = New LinearGradientBrush(New Rectangle(0, 0, Width, Height), Color.FromArgb(0, 176, 231), Color.FromArgb(0, 152, 224), 90.0F)
                PressedContourGB = New LinearGradientBrush(New Rectangle(0, 0, Width, Height), Color.FromArgb(0, 176, 231), Color.FromArgb(0, 152, 224), 90.0F)
    ...
    Class iTalk_TabControl
        ...
        Sub New()
            ...
            For Each Page As TabPage In Me.TabPages
                Page.BackColor = Color.FromArgb(33, 40, 50)
            Next
        End Sub
        ...
        Protected Overrides Sub OnControlAdded(ByVal e As ControlEventArgs)
            ...
            If TypeOf e.Control Is TabPage Then
                For Each i As TabPage In Me.Controls
                    i = New TabPage
                Next
                e.Control.BackColor = Color.FromArgb(33, 40, 50)
            End If
        End Sub
        ...
        Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
            ...
            With G
                ...
                .Clear(Color.FromArgb(33, 40, 50))
                .SmoothingMode = SmoothingMode.HighSpeed
                .CompositingQuality = Drawing2D.CompositingQuality.HighSpeed
                .CompositingMode = Drawing2D.CompositingMode.SourceOver

                ' Draw tab selector background
                .FillRectangle(New SolidBrush(Color.FromArgb(54, 57, 64)), New Rectangle(0, 0, ItemSize.Height + 4, Height))
                ...
                For TabIndex As Integer = 0 To TabCount - 1
                    If TabIndex = SelectedIndex Then
                        ...
                        Dim TabHighlighter As Rectangle = New Rectangle(New Point(GetTabRect(TabIndex).X - 0, GetTabRect(TabIndex).Location.Y - IIf(TabIndex = 0, 0, 0)), New Size(4, GetTabRect(TabIndex).Height - 7))
                        .FillRectangle(New SolidBrush(Color.FromArgb(181, 41, 42)), TabHighlighter)
                        ' Draw tab text
                        .DrawString(TabPages(TabIndex).Text, New Font(Font.FontFamily, Font.Size, FontStyle.Bold), New SolidBrush(Color.FromArgb(254, 255, 255)), New Rectangle(TabRect.Left + 10, TabRect.Top + 12, TabRect.Width - 40, TabRect.Height), New StringFormat With {.Alignment = StringAlignment.Near})
