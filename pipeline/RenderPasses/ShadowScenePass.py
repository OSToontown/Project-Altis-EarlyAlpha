...
class ShadowScenePass(RenderPass):
    ...
    def setShaders(self):
        casterShader = Shader.load(Shader.SLGLSL,
            "shaders/DefaultShaders/ShadowCasting/vertex.glsl",
            "shaders/DefaultShaders/ShadowCasting/fragment.glsl")
        ...
        casterShaderTransparent = Shader.load(Shader.SLGLSL,
            "shaders/DefaultShaders/TransparentShadowCasting/vertex.glsl",
            "shaders/DefaultShaders/TransparentShadowCasting/fragment.glsl")
