...
class RenderingPipeline(DebugObject):
    ...
    def fillTextureStages(self, nodePath):
        ...
        emptyDiffuseTex = loader.loadTexture("pipeline_data/Textures/EmptyDiffuseTexture.png")
        emptyNormalTex = loader.loadTexture("pipeline_data/Textures/EmptyNormalTexture.png")
        emptySpecularTex = loader.loadTexture("pipeline_data/Textures/EmptySpecularTexture.png")
        emptyRoughnessTex = loader.loadTexture("pipeline_data/Textures/EmptyRoughnessTexture.png")
    ...
    def getDefaultSkybox(self, scale=40000):
        ...
        skybox = loader.loadModel("pipeline_models/Skybox/Model.egg.bam")
        skybox.setScale(scale)

        skytex = loader.loadTexture("pipeline_data/Skybox/sky.jpg")
        ...
        skybox.setShader(Shader.load(Shader.SLGLSL, 
                "shaders/DefaultShaders/Opaque/vertex.glsl", 
                "shaders/Skybox/fragment.glsl"), 70)
    ...
    def _createDefaultTextureInputs(self):
        ...
        for color in ["White", "Black"]:
            emptyTex = loader.loadTexture("pipeline_data/Textures/" + color + ".png")
        ...
        texNoise = loader.loadTexture("pipeline_data/Textures/noise4x4.png")
        ...
        cubemapLookup = self.showbase.loader.loadCubeMap(
            "pipeline_data/Cubemaps/DirectionLookup/#.png")
        ...
        # Load the color LUT
        colorLUT = loader.loadTexture("pipeline_data/ColorLUT/" + self.settings.colorLookupTable)
