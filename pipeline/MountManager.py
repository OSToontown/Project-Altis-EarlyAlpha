...
class MountManager(DebugObject):
    ...
    def mount(self):
        ...
        vfs.mountLoop(join(self.basePath, 'pipeline_data'), 'pipeline_data', 0)
        vfs.mountLoop(join(self.basePath, 'pipeline_models'), 'pipeline_models', 0)
        ...
        getModelPath().appendDirectory(join(base_path.getFullpath(), 'shaders'))
