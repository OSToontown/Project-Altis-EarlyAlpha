...
QuestDict = {
    ...
    165: (TT_TIER + 1, Start, (CogQuest, Anywhere, 5, Any), 2001, Same, NA, (166, 167, 168, 169), TTLocalizer.QuestDialogDict[165]),
    ...
    170: (TT_TIER + 1, Cont, (DeliverGagQuest, 1, ToontownBattleGlobals.THROW_TRACK, 2), Same, Same, NA, 171, TTLocalizer.QuestDialogDict[170]),
    171: (TT_TIER + 1, Cont, (DeliverGagQuest, 1, ToontownBattleGlobals.SQUIRT_TRACK, 2), Same, Same, NA, 400, TTLocalizer.QuestDialogDict[171]),
    ...
    1009: (TT_TIER + 2, Start, (CogQuest, Anywhere, 6, 'sc'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    1014: (TT_TIER + 2, Start, (CogQuest, Anywhere, 6, 'p'), Any, ToonHQ, Any, NA, DefaultDialog),
    1015: (TT_TIER + 2, Start, (CogQuest, Anywhere, 4, 'bf'), Any, ToonHQ, Any, NA, DefaultDialog),
    1016: (TT_TIER + 2, Start, (CogQuest, Anywhere, 6, 'b'), Any, ToonHQ, Any, NA, DefaultDialog),
    1017: (TT_TIER + 2, Start, (CogQuest, Anywhere, 2, 'ym'), Any, ToonHQ, Any, NA, DefaultDialog),
    ...
    1022: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 7, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    1023: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 5, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    1024: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 6, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    1025: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 6, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    1026: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 8, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    1027: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 4, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1028: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 4, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    1029: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 4, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    1030: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 4, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    1031: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1032: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    1033: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    1034: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 5, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    1035: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 6, 'm'), Any, ToonHQ, Any, NA, DefaultDialog),
    1036: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 6, 's'), Any, ToonHQ, Any, NA, DefaultDialog),
    1037: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 6, 'c'), Any, ToonHQ, Any, NA, DefaultDialog),
    1038: (TT_TIER + 2, Start, (CogTrackQuest, ToontownGlobals.ToontownCentral, 6, 'l'), Any, ToonHQ, Any, NA, DefaultDialog),
    1039: (TT_TIER + 2, Start, (VisitQuest,), Any, 2219, NA, (1041, 1042, 1043), TTLocalizer.QuestDialogDict[1039]),
    1040: (TT_TIER + 2, Start, (VisitQuest,), Any, 2220, NA, 1041, TTLocalizer.QuestDialogDict[1040]),
    1041: (TT_TIER + 2, Cont, (VisitQuest,), Same, 2121, NA, 1042, TTLocalizer.QuestDialogDict[1041]),
    1042: (TT_TIER + 2, Cont, (RecoverItemQuest, 2100, 4, 21, Easy, 'c', 'track'), 2121, Same, NA, 1043, TTLocalizer.QuestDialogDict[1042]),
    1043: (TT_TIER + 2, Cont, (CogTrackQuest, 2100, 5, 'c'), Same, Same, NA, 1044, TTLocalizer.QuestDialogDict[1043]),
    1044: (TT_TIER + 2, Cont, (RecoverItemQuest, 2100, 1, 22, Easy, 'p'), Same, Same, NA, 1045, TTLocalizer.QuestDialogDict[1044]),
    ...
    1085: (TT_TIER + 2, Start, (VisitQuest,), Any, 2226, NA, 1086, TTLocalizer.QuestDialogDict[1085]),
    1086: (TT_TIER + 2, Start, (CogQuest, ToontownGlobals.ToontownCentral, 2, 'nd'), 2226, Same, NA, 1087, TTLocalizer.QuestDialogDict[1086]),
	1087: (TT_TIER + 2, Cont, (CogQuest, ToontownGlobals.ToontownCentral, 2, 'ym'), Same, Same, NA, 1088, TTLocalizer.QuestDialogDict[1087]),
	1088: (TT_TIER + 2, Cont, (CogQuest, ToontownGlobals.ToontownCentral, 2, 'tw'), Same, Same, NA, 1089, TTLocalizer.QuestDialogDict[1088]),
    1089: (TT_TIER + 2, Cont, (CogQuest, ToontownGlobals.ToontownCentral, 2, 'dt'), Same, Same, 100, NA, TTLocalizer.QuestDialogDict[1089]),
