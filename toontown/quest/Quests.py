...
QuestDict = {
    ...
    166: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 4, 'c'), Same, Same, NA, 400, TTLocalizer.QuestDialogDict[166]),
    167: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 4, 'l'), Same, Same, NA, 400, TTLocalizer.QuestDialogDict[167]),
    168: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 4, 's'), Same, Same, NA, 400, TTLocalizer.QuestDialogDict[168]),
    169: (TT_TIER + 1, Cont, (CogTrackQuest, Anywhere, 4, 'm'), Same, Same, NA, 400, TTLocalizer.QuestDialogDict[169]),
    170: (TT_TIER + 1, Cont, (DeliverGagQuest, 1, ToontownBattleGlobals.THROW_TRACK, 2), Same, Same, NA, 171, [170]),
    171: (TT_TIER + 1, Cont, (DeliverGagQuest, 1, ToontownBattleGlobals.SQUIRT_TRACK, 2), Same, Same, NA, 400, [171]),
