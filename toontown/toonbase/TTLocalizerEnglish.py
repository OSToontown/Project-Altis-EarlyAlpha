...
QuestDialogDict = {160: {GREETING: '',
 ...
 1304: {QUEST: "On Lighthouse Lane, Boardbots and Lawbots are highly common.\x07Go defeat 8 Lawbots on that street.",
		LEAVING: '',
		GREETING: ''},
 1305: {QUEST: "Now that you know your way around this neighborhood, it's fine I give you a new challenge.\x07You've seen the gray buildings on the streets?\x07Those are Cog Buildings.\x07They are really dangerous and they should not be attempted on your own.\x07Try to gather up some friends and take down a big one here in Donald's Dock.",
		LEAVING: '',
		GREETING: ''},
