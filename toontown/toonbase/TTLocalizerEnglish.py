...
QuestDialogDict = {160: {GREETING: '',
 ...
 1054: {QUEST: 'We here at the Toon HQ are researching the new cog department, Boardbots.\x07Our first target is the Con Artist.\x07We suspect that their berets contain many secrets.\x07Please recover 4 Berets from the Con Artists and report back to any HQ Officer.'},
