...
QuestDialogDict = {160: {GREETING: '',
 ...
 1077: {QUEST: "I am conducting research on the strongest cogs that roam in Toontown Central.\x07I need you to recover several gears from certain cogs.\x07Start off with a Yesman.",
        LEAVING: '',
		GREETING: '',
        INCOMPLETE_PROGRESS: 'Please return my goldfish to me.'},
 1078: {QUEST: "Now I need one from a Double Talker.",
        INCOMPLETE: 'What did _toNpcName_ have to say about the receipt?',
		GREETING: '',
        LEAVING: ''},
 1079: {QUEST: "Tighten up. Now I need a tightwad!",
 ...
 1092: {QUEST: "You name it, I'll drop it!",
        LEAVING: 'Now I\'m starting to sound like one of them...',
		GREETING: '',
        INCOMPLETE_PROGRESS: "I don't think there's anything else I can help you with.\x07Why don't you try and find that goldfish?"},
 1080: {QUEST: "Swindle around until you find a gear from a Swindler!",
        LEAVING: '',
		GREETING: '',
