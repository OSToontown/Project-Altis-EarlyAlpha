...
buildingChance = {
    ToontownGlobals.SillyStreet: config.GetFloat('silly-street-building-chance', 80.0),
    ToontownGlobals.LoopyLane: config.GetFloat('loopy-lane-building-chance', 80.0),
    ToontownGlobals.PunchlinePlace: config.GetFloat('punchline-place-building-chance', 80.0),
    ToontownGlobals.BarnacleBoulevard: config.GetFloat('barnacle-boulevard-building-chance', 85.0),
    ToontownGlobals.SeaweedStreet: config.GetFloat('seaweed-street-building-chance', 85.0),
    ToontownGlobals.LighthouseLane: config.GetFloat('lighthouse-lane-building-chance', 85.0),
    ToontownGlobals.ElmStreet: config.GetFloat('elm-street-building-chance', 95.0),
    ToontownGlobals.MapleStreet: config.GetFloat('maple-street-building-chance', 95.0),
    ToontownGlobals.OakStreet: config.GetFloat('oak-street-building-chance', 95.0),
    ToontownGlobals.AltoAvenue: config.GetFloat('alto-avenue-building-chance', 98.0),
    ToontownGlobals.BaritoneBoulevard: config.GetFloat('baritone-boulevard-building-chance', 98.0),
    ToontownGlobals.TenorTerrace: config.GetFloat('tenor-terrace-building-chance', 98.0),
