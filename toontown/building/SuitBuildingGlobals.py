...
buildingChance = {
    ToontownGlobals.SillyStreet: config.GetFloat('silly-street-building-chance', 75.0),
    ToontownGlobals.LoopyLane: config.GetFloat('loopy-lane-building-chance', 75.0),
    ToontownGlobals.PunchlinePlace: config.GetFloat('punchline-place-building-chance', 75.0),
