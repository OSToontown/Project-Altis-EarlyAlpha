...
SuitWaves = [generateSuits(10, [0, 4], [0, 0]),
 generateSuits(13, [2, 3], [0, 0]),
 generateSuits(17, [2, 4], [0, 0]),
 generateSuits(11, [2, 3], [0, 1]),
 generateSuits(14, [2, 2], [0, 1]),
 generateSuits(17, [2, 3], [0, 1]),
 generateSuits(8, [2, 3], [1, 2]),
 generateSuits(11, [2, 2], [2, 2]),
 generateSuits(17, [2, 3], [2, 2]),
 generateSuits(8, [2, 3], [2, 3]),
 generateSuits(11, [2, 2], [3, 3]),
 generateSuits(17, [2, 3], [3, 3]),
 generateSuits(8, [0, 2], [3, 4]),
 generateSuits(11, [2, 4], [4, 4]),
 generateSuits(17, [2, 3], [4, 4]),
 generateSuits(8, [1, 2], [4, 5]),
 generateSuits(11, [1, 4], [5, 5], True),
 generateSuits(16, [2, 3], [5, 5], True),
 generateSuits(8, [0, 2], [5, 6], True),
 generateSuits(11, [1, 2], [6, 6], True),
 generateSuits(16, [2, 3], [6, 6], True),
 generateSuits(10, [1, 3], [6, 7], True),
 generateSuits(15, [1, 4], [7, 7], True),
 generateSuits(16, [2, 4], [7, 7], True),
 generateSuits(15, [1, 3], [6, 7], True),
 generateSuits(20, [1, 4], [7, 7], True),
 generateSuits(25, [2, 4], [7, 7], True)]
SuitWaitWaves = [1,
 4,
 7,
 10,
