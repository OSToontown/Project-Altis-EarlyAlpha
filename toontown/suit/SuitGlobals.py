...
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['flunky', 'glasses'], '', 4.88),
                  ...
                  'tl': (7.3 / aSize, SuitDNA.corpPolyColor, ['headhoncho'], 'head-honcho.jpg', 9.5),
                  # Lawbots
                  ...
                  'lk': (7.0 / aSize, VBase4(.45, 0.45, .45, 1.0), ['barrister'], '', 8.69),
                  # Cashbots
                  ...
                  'bfh': (7.3 / cSize, VBase4(1, .3, .3, 1.0), ['bigfish'], '', 9.5),
                  # Sellbots
                  ...
                  'pm': (7.3 / aSize, VBase4(1, 1, .29, 1.0), ['toxicleader'], '', 10),
                  }
