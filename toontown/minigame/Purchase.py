...
class Purchase(PurchaseBase):
    ...
    def load(self):
        ...
        self.playAgain = DirectButton(parent=self.frame, relief=None, scale=1.04, pos=(1, 0, -0.24), image=(purchaseModels.find('**/PurchScrn_BTN_UP'),
        ...
        self.backToPlayground = DirectButton(parent=self.frame, relief=None, scale=1.04, pos=(1, 0, -0.045), image=(purchaseModels.find('**/PurchScrn_BTN_UP'),
         purchaseModels.find('**/PurchScrn_BTN_DN'),
         purchaseModels.find('**/PurchScrn_BTN_RLVR'),
