...
class PurchaseBase(StateData.StateData):
    ...
    def load(self, purchaseModels = None):
        ...
        self.statusLabel = DirectLabel(parent=self.frame, relief=None, pos=(-0.25, 0, 0.625), text=TTLocalizer.GagShopYouHave % self.toon.getMoney(), text_scale=TTLocalizer.PBstatusLabel, text_font=ToontownGlobals.getSignFont(), text_fg=(1, 1, 1, 1))
