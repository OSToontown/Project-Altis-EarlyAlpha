...
class DistributedPartyManagerAI(DistributedObjectAI):
    ...
    def partyInfoOfHostResponseUdToAi(self, partyStruct, inviteeIds):
        ...
        # This is issued in response to a request for the party to start, essentially. So let's allocate a zone
        ...
        # Don't forget this was initially started by a getPartyZone, so we better tell the host the party zone
