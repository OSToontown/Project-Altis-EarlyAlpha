...
CRBootedReasons = {1: 'Yikes - An unexpected problem occured.  Your connection has been lost, but you should be able to connect again and go right back into Toontown.',
 ...
 122: 'There was an issue getting you into Toontown.  If the problem persists, please contact Project Altis Support.',
 ...
 125: 'Your installed files appear to be invalid.  Use the official launcher to download the newest version, or contact Project Altis Support if the problem persists.',
 126: 'You aren\'t authorized to use administrator privileges. The request has been noted.',
 127: 'There appears to be a problem with your Toon.  Don\'t worry - we\'ll get it straightened out. Please contact Project Altis Support and referece Error Code 127.',
 ...
 152: "You have been banned from the game for a reported violation of our Terms of Use connected to '%(name)s'. For more details, please check the Project Altis website.",
 ...
 154: 'Project Altis is going down for an update!  Stay Tooned on our website for details, or try logging in again later.',
...
CRSystemMessages = {
    ...
    50: 'Project Altis will be closing for an update soon. Start wrapping things up!',
    51: 'Project Altis will be closing for an update in %s minutes.',
    52: 'Project Altis will be closing for an update in %s seconds.',
    53: 'Project Altis will be closing for an update in just a moment. Hang tight!',

    55: 'Project Altis will be closing for maintenance soon. Start wrapping things up!',
    56: 'Project Altis will be closing for maintenance in %s minutes.',
    57: 'Project Altis will be closing for maintenance in %s seconds.',
    58: 'Project Altis will be closing for maintanance in just a moment.',
...
CREnteringToontown = 'Project Altis'
