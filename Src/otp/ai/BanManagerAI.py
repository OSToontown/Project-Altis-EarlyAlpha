...
def kick():
    ...
    datagram.addString('You were kicked by a moderator who caught you not following the guidelines. Please contact support if you would like a full explanation of your kick.')
    simbase.air.send(datagram)
