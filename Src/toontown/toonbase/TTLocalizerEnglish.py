...
FunnyFarm = ('to', 'in', 'The Party Grounds')
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'ReOrg': ["You don't like the way I reorganized things!",
           ...
           "You're looking a little disorganized today.",
...
MusicTtiTheme = 'The Project Altis Theme'
...
CdrResultAlreadyRedeemed = "You've already received this item."
...
STOREOWNER_THANKSFISH = 'Thanks! The Pet Shop will love these. Happy Holidays!'
...
BackpackStylesDescriptions = {'bpb1': 'Blue Backpack',
 ...
 'bfl1': 'Flunky Pack by Savanah',
 'bfl2': 'Short Change Backpack',
 'bfl3': 'Bottom Feeder Backpack',
 'bfl4': 'Glad Hander Backpack'}
...
RentalJukebox = 'Jukebox!'
EstateCannonGameEnd = 'The Cannon Game rental is now over.'
GameTableRentalEnd = 'The Game Table rental is now over.'
JukeboxRentalEnd = 'The Jukebox rental is now over.'
...
ClothingTypeNames = {1001: 'Ghost Shirt',
 1002: 'Pumpkin Shirt',
 1112: 'Bee Shirt',
 1113: 'Toonosaur Shirt',
 1114: 'The Fishering Master',
 1115: 'The Golfing Master',
 1116: 'Unknown Shirt',
 1117: 'Bee Shorts',
 1118: 'Pirate Shorts',
 1119: 'Super Toon Shorts',
 1120: 'Toonosaur Shorts',
 1121: 'Unknown Shorts',
 1122: 'Pirate Shorts', 
 1123: 'Pirate Shorts',
...
ResistanceDanceItem = 'Make them %s'
ResistanceDanceChat = 'Toons of the World, Dance with me!'
ResistanceHappyMenu = 'Happy'
ResistanceHappyItem = 'Make us %s'
ResistanceHappyChat = 'Toons of the World, Be happy wih me!'
...
YinAlreadyBlack = "Ooow you're already black!"
YinPickColor = 'Ready to go to the summer party?'
FlippySummerLeave = 'Ready to go back to Toontown Central?'
YinEnjoy = 'Oooow Spooky! You are now permanently a black cat.'
YinGoodbye = 'Okay then! See you later!'
YangTitle = 'Are you absolutely sure?'
YangNotBear = 'Sorry, I only make bears polar!'
YangAlreadyWhite = "You're already white!"
YangPickColor = 'Merry Christmas! Are you sure you want to be a polar bear?'
YangEnjoy = 'Have a Merry Christmas!! You are now permanently a polar bear.'
YangGoodbye = 'Okay, then. See you later!'
NonASCII = 'Sorry! Project Altis does not support non-ASCII characters!'
ClothesShopShirtsStyle = 'Shirt Style'
ClothesShopShirtsColor = 'Shirt Color'
ClothesShopShortsStyle = 'Short Style'
ClothesShopShortsColor = 'Short Color'
...
BugReportNotice = 'This will open your web broswer to the Project Altis Bug Report page\n\nDo you wish to continue?' 
FireMessages = ("You're FIRED!", "The chairman called and said, you're FIRED!", "You're fired! Literally!", "Pack your bags, I'm taking you on a trip!")

BossLocations = {
 'c': 'Bossbot Clubhouse\nBanquet',
 'l': "Lawbot Courthouse\nBumpy Bumblebehr's Trial",
 'm': 'The Cashbot Treasury Vault',
 's': 'Sellbot Towers\nRooftop'
} 
...
houseNames = {
    HouseGlobals.HOUSE_DEFAULT: 'Default House',
    ...
    HouseGlobals.HOUSE_CABIN: 'Cozy Cabin'
}

def getHouseNameById(houseId):
    return houseNames[houseId]

QuestsPieThrowReward = 'You now have %(count)d %(type)s to throw. Press "Delete" to throw them!'
QuestsPieThrowRewardPoster = 'Reward: %(count)d %(type)s'
QuestsPieThrowRewardPosterS = 'Reward: %(count)d %(type)s' 
