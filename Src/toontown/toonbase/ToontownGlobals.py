...
SILLY_SATURDAY = 125
BLACK_CAT_DAY = 126
APRIL_TOONS_WEEK = 127
IDES_OF_MARCH = 128
CHRISTMAS = 129
HALLOWEEN = 130
SUMMER_FIREWORKS = 131
NEW_YEAR_FIREWORKS = 132
VALENTOONS_DAY = 133
...
#change later on to our site
BugReportSite = 'http://google.com'

#House Exterior Prices

housePrices ={
    HouseGlobals.HOUSE_DEFAULT: 5000,
...
FluffyDNA = {'Fluffy': [-1,0,0,-1,4,0,1,5,1]}