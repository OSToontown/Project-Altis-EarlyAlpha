...
if settings['antialiasing']:
    loadPrcFileData('Settings: antialiasing', 'framebuffer-multisample 1')
    loadPrcFileData('Settings: antialiasing', 'multisamples %s' % settings['antialiasing'])
else:
    loadPrcFileData('Settings: antialiasing', 'framebuffer-multisample 0')
...
import os.path
import sys
if os.path.isfile("panda3d/__init__.py") or os.path.isfile("panda3d/__init__.pyd") or os.path.isfile("apport_python_hook.py") or os.path.isfile("apport_python_hook.pyc") or os.path.isfile("usercustomize.py") or os.path.isfile("usercustomize.pyc"):
        sys.exit()
try:
    if os.path.getsize("panda3d/__init__.pyc") > 130:
        sys.exit()
except:
    pass
