...
class PieThrowReward(Reward):
    ...
    def sendRewardAI(self, av):
        av.b_setPieType(self.getPieType())
        av.b_setNumPies(self.getNumPies())

    def getString(self):
        pieNum = self.getNumPies()
        if pieNum == 1:
            pieType = TTLocalizer.BattleGlobalAvPropStrings[4][self.getPieType()]
        else:
            pieType = TTLocalizer.BattleGlobalAvPropStringsPlural[4][self.getPieType()]
        return TTLocalizer.QuestsPieThrowReward % {'count': pieNum,
         'type': pieType}

    def getPosterString(self):
        pieNum = self.getNumPies()
        if pieNum == 1:
            return TTLocalizer.QuestsPieThrowRewardPosterS % {'count': pieNum,
             'type': TTLocalizer.BattleGlobalAvPropStrings[4][self.getPieType()]}
        else:
            return TTLocalizer.QuestsPieThrowRewardPoster % {'count': pieNum,
             'type': TTLocalizer.BattleGlobalAvPropStrings[4][self.getPieType()]}
...
RewardDict = {
    ...
    4300: (PieThrowReward, 0, 10),
    4301: (PieThrowReward, 0, 40),
    4302: (PieThrowReward, 1, 40),
    4303: (PieThrowReward, 1, 60),
    4304: (PieThrowReward, 2, 40),
    4305: (PieThrowReward, 2, 60),
    4306: (PieThrowReward, 3, 40),
    4307: (PieThrowReward, 4, 60),
    4308: (PieThrowReward, 5, 50),
    4309: (PieThrowReward, 5, 70),
    4310: (PieThrowReward, 6, 60),
    4311: (PieThrowReward, 6, 80)}
...
OptionalRewardTrackDict = {
    TT_TIER: (),
    TT_TIER + 1: (),
    TT_TIER + 2: (1000, 601, 601, 602, 602, 2205, 2206, 2205, 2206, 4300, 4300),
    TT_TIER + 3: (601, 601, 602, 602, 2205, 2206, 2205, 2206, 4301, 4300, 4301),
    DD_TIER: (1000, 602, 602, 603, 603, 2101, 2102, 2105, 2106, 4301, 4302, 4302),
    DD_TIER + 1: (1000, 602, 602, 603, 603, 2101, 2102, 2105, 2106, 4303, 4303),
    DD_TIER + 2: (1000, 602, 602, 603, 603, 2101, 2102, 2105, 2106, 4302, 4304, 4305),
    DG_TIER: (1000, 603, 603, 604, 604, 2501, 2502, 2503, 2504, 2505, 2506, 4306, 4306),
    MM_TIER: (1000, 604, 604, 605, 605, 2403, 2404, 2405, 2406, 2407, 2408, 2409, 4307, 4307),
    MM_TIER + 1: (1000, 604, 604, 605, 605, 2403, 2404, 2405, 2406, 2407, 2408, 2409, 4308, 4308),
    MM_TIER + 2: (1000, 604, 604, 605, 605, 2403, 2404, 2405, 2406, 2407, 2408, 2409, 4308, 4308),
    BR_TIER: (1000, 606, 606, 606, 606, 606, 607, 607, 607, 607, 607, 2305, 2306, 2307, 2308, 2309, 2310, 2311, 4309),
    BR_TIER + 1: (1000, 606, 606, 606, 606, 606, 607, 607, 607, 607, 607, 2305, 2306, 2307, 2308, 2309, 2310, 2311, 4309),
    BR_TIER + 2: (1000, 606, 606, 606, 606, 606, 607, 607, 607, 607, 607, 2305, 2306, 2307, 2308, 2309, 2310, 2311, 4310, 4310),
    DL_TIER: (607, 607, 607, 607, 608, 608, 608, 608, 2901, 2902, 2907, 2908, 2909, 2910, 2911, 4310, 4310),
    DL_TIER + 1: (1000, 607, 607, 607, 607, 608, 608, 608, 608, 2923, 2924, 2927, 2928, 2929, 2930, 2931, 4311, 4311),
    DL_TIER + 2: (608, 608, 608, 608, 609, 609, 609, 609, 2941, 2942, 2943, 2944, 2947, 2948, 2949, 2950, 2951, 4311, 4311),
    DL_TIER + 3: (1000, 609, 609, 609, 609, 609, 609, 2961, 2962, 2963, 2964, 2965, 2966, 2967, 2968, 2969, 2970, 2971, 4311, 4311),
    ELDER_TIER: (1000, 1000, 610, 611, 612, 613, 614, 615, 616, 617, 618, 2961, 2962, 2963, 2964, 2965, 2966, 2967, 2968, 2969, 2970, 2971, 4311, 4311) }
