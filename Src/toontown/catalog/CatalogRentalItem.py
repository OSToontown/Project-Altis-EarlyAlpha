...
class CatalogRentalItem(CatalogItem.CatalogItem):
    ...
    def getName(self):
        ...
        elif self.typeIndex == ToontownGlobals.RentalJukebox:
            return '%s %s %s' % (hours, TTLocalizer.RentalHours, TTLocalizer.RentalJukebox)
        else:
            return TTLocalizer.RentalTypeName
    ...
    def recordPurchase(self, avatar, optional):
        ...
        if avatar:
            ...
            if estate:
                expiration = int(time.time()) + (self.duration * 60)
                estate.rentItem(self.typeIndex, expiration)
            else:
    ...
    def getPicture(self, avatar):
        ...
        if self.typeIndex == ToontownGlobals.RentalCannon:
            ...
            model = loader.loadModel('phase_13/models/parties/jukebox_model')
