...
MonthlySchedule = ((7,
 ...
 (1,
  ...
  (
   ...
   CatalogRentalItem(2, 2880, 1000),
   CatalogRentalItem(3, 2880, 1000),
   #CatalogGardenStarterItem(), 
   CatalogNametagItem(100),
   CatalogNametagItem(15),
   CatalogNametagItem(16),
   CatalogAccessoryItem(176),
   CatalogAccessoryItem(450),
   CatalogAccessoryItem(451),
   CatalogAccessoryItem(452),
   CatalogAccessoryItem(453),
   CatalogAccessoryItem(454),
   CatalogAccessoryItem(455),
   ...
   CatalogEmoteItem(25, 0),
   CatalogEmoteItem(26, 0),
   CatalogEmoteItem(27, 0),
   CatalogEmoteItem(28, 0),
   CatalogEmoteItem(29, 0),
   CatalogEmoteItem(30, 0),
   CatalogEmoteItem(31, 0),
   CatalogEmoteItem(32, 0),
   CatalogEmoteItem(33, 0))),
 (5,
  26,
  6,
  30,
