...
def createNPC(air, npcId, desc, zoneId, posIndex = 0, questCallback = None):
    ...
    elif type == NPC_SNOWBALL:
            npc = DistributedNPCFlippyAI.DistributedNPCFlippyAI(air, npcId)
    else:
...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK,
 ...
 1329: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        3),
 19018: (ToontownBattleGlobals.DROP_TRACK,
         2,
         200,
         7),
 19019: (ToontownBattleGlobals.DROP_TRACK,
         1,
         200,
         7)}
