...
class DDSafeZoneLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def load(self):
        ...
        #Temporarily added into the code until the model is fixed.
        wc = CollisionBox(Point3(7, 0, 0), 12, 0.5, 18)
        self.fencefix = base.render.attachNewNode(CollisionNode('wallhole_collision'))
        self.fencefix.node().addSolid(wc)
        self.fencefix.setPos(75.20, 84.11, 0.0)
        self.fencefix.setH(271)

        
    def unload(self):
        SafeZoneLoader.SafeZoneLoader.unload(self)
        self.fencefix.removeNode()
